    ...
    public class filter
    {
        ...
        public void init(Dictionary<string, filter> fAll)
        {
            ...
            /*{
                ...
                string filter = x.Filter;
                string canonicalName = x.CanonicalName;
                string itemName = x.ItemName;
                string name = x.Name;
                string uniqueIdentifier = x.UniqueIdentifier;

                ProjectItem projectItem = (ProjectItem)x.Object;

                bool parseFiles = x.ParseFiles;
                bool sourceControlFiles = x.SourceControlFiles;
                eWebRefUrlBehavior urlBehavior = x.UrlBehavior;
                string webReference = x.WebReference;
                ...
                VCProject project = (VCProject)x.project;
                VCProjectEngine vcProjectEngine = (VCProjectEngine)x.VCProjectEngine;
            }*/
