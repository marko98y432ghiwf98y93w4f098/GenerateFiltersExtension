                    ...
                    {
                        {
                            ...
                            if (c is Form c2 && c2.Parent == null && p != null)
                            {
                                var p2 = p.Value - (Size)c2.Location;
                                if (v0 != null)
                                    p2 = v0.rec().f(p2);
                                d2.x.x = p.Value - (Size)v.f(p2);
                            }
                            else
                                d2.x.x = v.f(x.x);          //scale          point

                            if (c is Form)
                            {
                                //d2.x2.s2 = x3.s2.xScale();
                                d2.x.x2.s = f3(x.x2.s);
                            }
                            else
                                d2.x.x2.s = v.f(x.x2.s);          //scale          size
                            d2.x.x2.s2 = v.f(x.x2.s2);


                            d2.x.x4.f = v.f(x.x4.f);          //scale          font
                        }
